...
An alternative way is by downloading the [ZIP file](https://github.com/TiagoOlivoto/paper_pliman/archive/refs/heads/master.zip) containing the scripts and all needed images ()
