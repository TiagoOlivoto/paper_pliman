...
## Getting the id for each object
...
Another way to compute the diased area is by using an RGB-based phenotyping^[https://link.springer.com/article/10.1007/s40858-021-00448-y]. The first step is to find a suitable index for disease segmentation.
