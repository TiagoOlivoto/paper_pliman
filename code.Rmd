...
Fifty soybean leaves previously processed in QUANT software were used. The images were retrieved from https://osf.io/4hbr6, a Plant Disease Severity Annotation Image Database. Thanks to [Emerson M. Del Ponte](https://osf.io/jb6yd/) and his collaborators for keeping this important project publicly available.
...
# Count objects
## Images
```{r count_imgs, fig.width=10, fig.height=11}
imgs <- list(
