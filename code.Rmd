...
library(epiR) # concordance correlation coefficient
...
validation <- rio::import("data/count_objects/count_data.xlsx")
...
ggplot(validation, aes(REAL, PREDICTED))+
  ...
  labs(x = "Real number of seeds",
       y = "Counted number of seeds") +
